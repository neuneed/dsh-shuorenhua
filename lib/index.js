...
var ShuorenhuaRuntime = class extends (_a = TypertRemoteService, _humanize_dec = [Remote], _a) {
  ...
  async humanize(text, mode) {
    const selectedMode = mode || this.config.defaultMode || "natural";
...
function registerShuorenhuaTools(ctx, config = {}) {
  ...
  try {
    toolsService = ctx.reflect?.get("tools") ?? ctx.tools;
  } catch {
  }
  ...
  return toolsService.register({
    ...
    description: "\u628A\u7ED9\u5B9A\u7684AI\u56DE\u7B54\u3001\u516C\u6587\u6216\u5197\u957F\u6587\u672C\u8F6C\u5316\u4E3A\u901A\u4FD7\u3001\u7B80\u7EC3\u3001\u53BB\u9664\u5957\u8BDD\u7684\u4EBA\u8BDD\u3002\u652F\u6301\u4E09\u79CD\u6A21\u5F0F\uFF1Anatural\uFF08\u81EA\u7136\u4EBA\u8BDD\uFF0C\u6D88\u9664\u516C\u6587\u5473\u4E0E\u516B\u80A1\u8BCD\uFF09\u3001concise\uFF08\u6781\u7B80\u5927\u767D\u8BDD\uFF0C\u76F4\u51FB\u8981\u70B9\uFF09\u3001code_first\uFF08\u7A0B\u5E8F\u5458\u76F4\u7403\uFF0C\u4F18\u5148\u4FDD\u7559\u4EE3\u7801\u3001\u547D\u4EE4\u4E0E\u6392\u67E5\u6B65\u9AA4\uFF09\u3002",
    parameters: {
      type: "object",
      required: ["text"],
      properties: {
...
var Config = Schema.object({
  defaultMode: Schema.string().default("natural"),
...
function apply(ctx, config) {
  ...
  ctx.effect(() => {
    ...
    try {
      if (ctx.typert) {
        if (typeof ctx.typert.register === "function") {
          dispose = ctx.typert.register(TYPERT_MANIFEST);
        } else if (ctx.typert.remotes && typeof ctx.typert.remotes.register === "function") {
          dispose = ctx.typert.remotes.register(TYPERT_MANIFEST);
        }
      }
    } catch {
    }

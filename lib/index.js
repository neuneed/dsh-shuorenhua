...
function applyDenominalization(text) {
...
function stripRepetitiveEchoes(text) {
  const actions = "\u8C03\u6574|\u4FEE\u6539|\u4F18\u5316|\u66F4\u65B0|\u91CD\u6784|\u91CD\u5199|\u68C0\u67E5|\u6D4B\u8BD5|\u68B3\u7406|\u91CD\u547D\u540D|\u4FEE\u590D|\u6392\u67E5|\u6539\u9020|\u9002\u914D|\u5347\u7EA7|\u9A8C\u8BC1|\u4E0A\u7EBF|\u53D1\u5E03|\u6E05\u7406|\u5BF9\u9F50|\u8FC1\u79FB|\u6838\u5BF9|\u66FF\u6362";
...
function registerShuorenhuaTools(ctx, config = {}) {
...
var PROVIDER_NAME = "shuorenhua-skills";
var SKILLS_PATH = fileURLToPath(new URL("../skills/", import.meta.url));
var RANK = 400;
var SOURCE = "bundled";
...
async function loadSkill(directory, dirName) {
  const skillPath = join(directory, "SKILL.md");
  const raw = await readFile(skillPath, "utf8");
  const parsed = parseFrontmatter(raw);
  if (parsed === void 0) throw new Error(`${skillPath} has no frontmatter`);
...
function registerShuorenhuaSkills(ctx) {
  const skills = ctx.get("skills");
  if (!skills || typeof skills.registerProvider !== "function") {
    return () => {
    };
  }
  return skills.registerProvider((_control) => createProvider(ctx));
}
